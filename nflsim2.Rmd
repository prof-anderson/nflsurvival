...
Took a pause for the holidays and continued in mid-December.

Used Google Gemini to assist with vibe coding an R Script for the analysis, `nflsurvival-Script.R.` This required many iterations of testing and refinement but generated `nflsurvival-Script-v02.R` and `nflsurvival-Script-v03.R` above. Notably, `v02` uses the actual game results rather than the simulated results in `v03`. The final version is `nflsurvival-Script-v03.R` which will be discussed later in this Rmd document.

Version 3 still needs more work on the following items:

-   Proofreading the R Script.

-   Testing alternate heuristics

-   Better organizing results

-   Looping for simulated results

-   Exploring whether the season ELOs are updated realistically
